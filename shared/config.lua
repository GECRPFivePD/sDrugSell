...
Config.SellKeybind = '' -- Keybind to sell drugs (you can either use the command or the keybind)

Config.ZoneControlCommand = 'zonecontrol' -- Command to control zones
Config.ZoneControlKeybind = '' -- Keybind to control zones (you can either use the command or the keybind)
